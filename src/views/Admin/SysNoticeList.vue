  ...
  <template>
    <div class="app-container">
            ...
            <div class="tb-body">
                <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="120px" :style="`flex:1;`">
                    <el-form-item label="通知标题" prop="Name">
                        <el-input v-model.trim="searchForm.Name" placeholder="请输入通知标题"></el-input>
                    </el-form-item>
                    <el-form-item label="作者" prop="Author">
                        <el-input v-model.trim="searchForm.Author" placeholder="请输入作者"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog title="系统通知编辑对话框" :visible.sync="editorShow" width="80%" :lock-scroll="true" height="800px">
            <el-form v-if="editorShow == true" ref="editModalForm" :rules="editModalFormRules" :model="formData"
                label-width="160px" size="mini">
                <el-row :gutter="10">
                    <el-col :span="12">
                        <el-form-item label="通知标题" prop="Name">
                    ...
                    <el-col :span="12">
                        <el-form-item label="附件" prop="File">
                            <el-upload-files :limit="1" v-model="formData.File"></el-upload-files>
                        </el-form-item>
                    </el-col>
                </el-row>
        ...
        <data-table ref="tableId" url="/SysNotice/List" :column="dataColum">
    ...
    methods: {
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    this.lock = 1;
                    var { Success } = await this.$PostLoading(`/SysNotice/CreateOrEdit`, this.formData);
                    this.lock = 0;
                    if (Success) {

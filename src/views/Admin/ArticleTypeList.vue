  ...
  <template>
    <div class="app-container">
            ...
            <div class="tb-body">
                <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="120px" :style="`flex:1;`">
                    <el-form-item label="资讯名称" prop="Title">
                        <el-input v-model.trim="searchForm.Title" placeholder="请输入资讯名称进行精确搜索"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog title="资讯类型编辑对话框" :visible.sync="editorShow" width="80%" :lock-scroll="true" height="800px">
            <el-form v-if="editorShow == true" ref="editModalForm" :rules="editModalFormRules" :model="formData"
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :span="12">
                        <el-form-item label="资讯封面" prop="ImageUrls">
        ...
        <data-table ref="tableId" url="/ArticleType/List" :column="dataColum">
...
export default {
    ...
    methods: {
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/ArticleType/Get`, { Id: Id });
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    this.lock = 1;
                    var { Success } = await this.$PostLoading(`/ArticleType/CreateOrEdit`, this.formData);
                    this.lock = 0;
                    if (Success) {
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/ArticleType/Delete`, { Id: Id });
            this.$refs.tableId.reload();
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/ArticleType/BatchDelete`, { Ids: ids });
            this.$refs.tableId.reload();
        },
        /**
         * 点击表格搜索按钮会触发

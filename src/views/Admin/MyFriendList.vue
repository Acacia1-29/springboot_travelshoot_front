  ...
  <template>
    <div class="app-container">
        ...
        <el-dialog  title="我的好友编辑对话框" :visible.sync="editorShow" width="80%" :lock-scroll="true" height="800px">
            <el-form v-if="editorShow == true" ref="editModalForm" :rules="editModalFormRules" :model="formData"
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :span="12">
                        <el-form-item label="是否拉黑" prop="IsDeFriend">
                       		  <el-switch v-model="formData.IsDeFriend" >
                            </el-switch>                          
                        </el-form-item>
                    </el-col>
                </el-row>
        ...
        <data-table ref="tableId" url="/MyFriend/List" :column="dataColum">
...
export default {
    ...
    methods: {
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/MyFriend/Get`, { Id: Id });
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    this.lock = 1;
                    var { Success } = await this.$PostLoading(`/MyFriend/CreateOrEdit`, this.formData);
                    this.lock = 0;
                    if (Success) {
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/MyFriend/Delete`, { Id: Id });
            this.$refs.tableId.reload();
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/MyFriend/BatchDelete`, { Ids: ids });
            this.$refs.tableId.reload();
        },
        /**
         * 点击表格搜索按钮会触发

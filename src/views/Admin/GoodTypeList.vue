  ...
  <template>
    <div class="app-container">
            ...
            <div class="tb-body">
                <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="120px" :style="`flex:1;`">
                    <el-form-item label="类型名称" prop="Name">
                        <el-input v-model.trim="searchForm.Name" placeholder="请输入类型名称进行精确搜索"></el-input>
                    </el-form-item>
                    <el-form-item label="类型编码" prop="Code">
                        <el-input v-model.trim="searchForm.Code" placeholder="请输入类型编码进行精确搜索"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog title="商品类型编辑对话框" :visible.sync="editorShow" width="80%" :lock-scroll="true" height="800px">
        ...
        <data-table ref="tableId" url="/GoodType/List" :column="dataColum">
    ...
    methods: {
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    this.lock = 1;
                    var { Success } = await this.$PostLoading(`/GoodType/CreateOrEdit`, this.formData);
                    this.lock = 0;
                    if (Success) {

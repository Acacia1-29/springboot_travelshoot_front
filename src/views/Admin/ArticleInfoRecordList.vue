  ...
  <template>
    <div class="app-container">
        ...
        <el-dialog title="资讯浏览记录编辑" :visible.sync="editorShow" width="80%" :lock-scroll="true" height="800px">
        ...
        <data-table ref="tableId" url="/ArticleInfoRecord/List" :column="dataColum">
...
export default {
    ...
    methods: {
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/ArticleInfoRecord/Get`, { Id: Id });
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    this.lock = 1;
                    var { Success } = await this.$PostLoading(`/ArticleInfoRecord/CreateOrEdit`, this.formData);
                    this.lock = 0;
                    if (Success) {
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/ArticleInfoRecord/Delete`, { Id: Id });
            this.$refs.tableId.reload();
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/ArticleInfoRecord/BatchDelete`, { Ids: ids });
            this.$refs.tableId.reload();
        },
        /**
         * 点击表格搜索按钮会触发

  ...
  <template>
    <div class="app-container">
        ...
        <el-dialog title="甜品属性编辑" :visible.sync="editorShow" width="80%" :modal="false" :lock-scroll="true" height="800px">
        ...
        <data-table ref="tableId" url="/GoodProps/List" :where="{ GoodId: this.GoodId }" :column="dataColum">
...
export default {
    ...
    methods: {
        ...
        async ShowEditModal(Id) {
            ...
            this.formData = Data;
            this.formData.GoodId = this.GoodId;

...
<template>
    <div class="app-container">
            ...
            <div class="tb-body">
                <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="120px" :style="`flex:1;`">
                    <el-form-item label="订单编号" prop="Code">
                        <el-input v-model.trim="searchForm.Code" placeholder="请输入订单编号进行精确搜索"></el-input>
                    </el-form-item>

                    <el-form-item label="备注" prop="Remark">
                        <el-input v-model.trim="searchForm.Remark" placeholder="请输入备注进行精确搜索"></el-input>
                    </el-form-item>
                    <el-form-item label="物流单号" prop="LogisticsNo">
                        <el-input v-model.trim="searchForm.LogisticsNo" placeholder="请输入物流单号进行精确搜索"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="支付方式" prop="PayType">
                        <el-input v-model.trim="searchForm.PayType" placeholder="请输入支付方式进行精确搜索"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog title="我的评价" :visible.sync="editorShow" width="80%" :lock-scroll="true" height="800px">
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :span="24">
                        <el-form-item label="评价" prop="Comment">
                            <el-input type="textarea" :rows="4" v-model.trim="formData.Comment"></el-input>
                        </el-form-item>
                    </el-col>
        ...
        <data-table ref="tableId" url="/OrderInfo/List" :column="dataColum" :where="{ BuyUserId: userId }">
            ...
            <template v-slot:operate="scope">
                ...
                <el-button type="text" v-if="scope.row.OrderStatus == 3" @click="Comment(scope.row.Id)">评 价</el-button>
                <el-button type="text" v-if="scope.row.OrderStatus == 2" @click="GetGood(scope.row.Id)">确 认 收 货</el-button>

                <el-button type="text" v-if="scope.row.OrderStatus == 1" @click="ShowDeleteModal(scope.row.Id)">取 消 订
                    单</el-button>
            </template>
        </data-table>
...
export default {
    ...
    methods: {
         ...
         */
        async GetGood(Id) {
            await this.$PostSigleUpdate(`/OrderInfo/Get`, `/OrderInfo/CreateOrEdit`, Id, "我确认已经收货了!", { OrderStatus: 3 });
